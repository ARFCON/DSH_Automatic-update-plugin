window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function UpdatesTab(props) {
			const t = props.t;
			const [state, setState] = react.useState({ status: "loading", entries: [], desktop: null, desktopPlugins: null, checkedAt: null, checking: false, error: null, filters: [], expandedDesc: null });
				...
				children: [
					...
					(0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							["npm", "github", "local", "git"].map((key) => (0, react_jsx_runtime.jsx)("button", {
								type: "button",
					...
					state.desktopPlugins !== null && state.desktopPlugins !== undefined ? (0, react_jsx_runtime.jsxs)("div", {
						className: s.section,
						...
						children: [
							...
							state.desktopPlugins.length > 0 ? (0, react_jsx_runtime.jsx)("ul", {
								...
								children: state.desktopPlugins.map((ap) => {
									const gh = ap.github;
									const apState = ap.updateable ? t("stateUpdate") : ap.latest ? t("stateUpToDate") : t("stateNoRegistry");
									return (0, react_jsx_runtime.jsxs)("li", {
										className: s.row,
