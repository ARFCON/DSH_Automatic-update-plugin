...
const BOOL_CODEC = {
  mode: 'strict',
  typeSymbol: 'dsh-plugin-updates/types#EnabledFlag',
  schema: z.boolean()
}
...
export const TYPERT = {
  ...
  invocations: [
    ...
    {
      id: 'dsh-plugin-updates#pluginUpdates/updateAll',
      service: 'pluginUpdates',
      namespace: 'pluginUpdates',
      method: 'updateAll',
      invocation: { kind: 'direct' },
      parameters: [],
      result: JSON_CODEC('dsh-plugin-updates/types#UpdateAllResult')
    },
    {
    ...
    {
      id: 'dsh-plugin-updates#pluginUpdates/updateAssetPlugin',
      service: 'pluginUpdates',
      namespace: 'pluginUpdates',
      method: 'updateAssetPlugin',
      invocation: { kind: 'direct' },
      parameters: [
        { name: 'name', wire: 'name', source: 'json', codec: NAME_CODEC }
      ],
      result: JSON_CODEC('dsh-plugin-updates/types#UpdateAssetResult')
    },
    {
      id: 'dsh-plugin-updates#pluginUpdates/setEnabled',
      service: 'pluginUpdates',
      namespace: 'pluginUpdates',
      method: 'setEnabled',
      invocation: { kind: 'direct' },
      parameters: [
        { name: 'name', wire: 'name', source: 'json', codec: NAME_CODEC },
        { name: 'enabled', wire: 'enabled', source: 'json', codec: BOOL_CODEC }
      ],
      result: JSON_CODEC('dsh-plugin-updates/types#SetEnabledResult')
    }
  ],
  model: {
    services: [],
